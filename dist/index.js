...
var ArabicWord = /** @class */ (function () {
    ...
    ArabicWord.prototype.processing = function (num) {
        ...
        var sections = this.splitIntoSections(num);
        var sectionBeforePoint = [];
        var sectionAfterPoint = [];
        var phases = [];
    ...
    ArabicWord.prototype.processSection = function (section) {
        var _this = this;
        var parts = this.splitIntoParts(section);
        var partsAsWords = [];
    ...
    ArabicWord.prototype.splitIntoSections = function (num) {
        return num.split(".", 2);
    };
